...
filePaths.forEach(relPath => {
  ...
  if (relPath === 'app/landing/page.tsx') {
    content = content.replace(
      ...
      '<Image src="/bpkad-logo.jpeg" alt="BPKAD" width={40} height={40} className="object-contain" />'
    );
  ...
  if (relPath === 'app/dashboard/layout.tsx') {
    content = content.replace(
      ...
      '<div className="flex h-8 w-8 items-center justify-center bg-white rounded-lg p-1 shadow-sm"><Image src="/bpkad-logo.jpeg" alt="BPKAD" width={24} height={24} className="object-contain" /></div>'
    );
    content = content.replace(
      ...
      '<div className="flex h-7 w-7 items-center justify-center bg-white rounded p-0.5 shadow-sm md:hidden"><Image src="/bpkad-logo.jpeg" alt="BPKAD" width={20} height={20} className="object-contain" /></div>'
    );
  }
  ...
  if (authFiles.includes(relPath)) {
    content = content.replace(
      ...
      '<div className="flex items-center justify-center w-16 h-16 bg-white rounded-2xl p-2 shadow-lg mb-4"><Image src="/bpkad-logo.jpeg" alt="BPKAD" width={56} height={56} className="object-contain" /></div>'
    );
    content = content.replace(
      /<div className="flex items-center justify-center w-10 h-10 rounded bg-sky-500 font-bold">\s*S\s*<\/div>/,
      '<div className="flex items-center justify-center w-10 h-10 bg-white rounded p-1 shadow-sm"><Image src="/bpkad-logo.jpeg" alt="BPKAD" width={32} height={32} className="object-contain" /></div>'
    );
  }
  ...
  if (relPath === 'app/auth/sign-up-success/page.tsx' || relPath === 'app/auth/error/page.tsx') {
    content = content.replace(
      ...
      '<div className="flex h-12 w-12 items-center justify-center bg-white rounded p-1 shadow-sm mb-2"><Image src="/bpkad-logo.jpeg" alt="BPKAD" width={40} height={40} className="object-contain" /></div>'
    );
  }
